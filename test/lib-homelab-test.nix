# Unit tests for lib-homelab.nix
...
lib.debug.throwTestFailures {
  failures = lib.runTests rec {
    ...
    # === nameToIp Tests ===
    test_router_ipv4 = {
      expr = lib.homelab.nameToIp.router;
      expected = "172.22.0.1";
    };
    test_b1_ipv4 = {
      expr = lib.homelab.nameToIp.b1;
      expected = "172.22.1.1";
    };
    test_c1_1_ipv4 = {
      expr = lib.homelab.nameToIp."c1-1";
      expected = "172.22.1.2";
    };
    test_pihole_1_ipv4 = {
      expr = lib.homelab.nameToIp.pihole-1;
      expected = "172.22.3.1";
    };
    test_dns_alias = {
      expr = lib.homelab.nameToIp.dns;
      expected = lib.homelab.nameToIp.pihole-1;
    };
    test_dhcp_alias = {
      expr = lib.homelab.nameToIp.dhcp;
      expected = lib.homelab.nameToIp.pihole-1;
    };
    test_ha_alias = {
      expr = lib.homelab.nameToIp.ha;
      expected = lib.homelab.nameToIp."home-assistant";
    };
    test_pihole_host_alias = {
      expr = lib.homelab.nameToIp."pihole-1-host";
      expected = lib.homelab.nameToIp.b1;
    };
    test_server_climate_ip = {
      expr = lib.homelab.nameToIp."server-climate";
      expected = "172.21.1.20";
    };
    test_sprinklers_ip = {
      expr = lib.homelab.nameToIp.sprinklers;
      expected = "172.21.2.30";
    };
    test_octoprint_ip = {
      expr = lib.homelab.nameToIp.octoprint;
      expected = "172.21.31.8";
    };

    # === nameToIp6 Tests ===
    test_pihole_ipv6 = {
      expr = lib.homelab.nameToIp6.pihole-1;
      expected = "2001:55d:b00b:1:224:bff:fe16:301";
    };
    test_b1_ipv6 = {
      expr = lib.homelab.nameToIp6.b1;
      expected = "2001:55d:b00b:1:224:bff:fe16:101";
    };
    test_c1_1_ipv6 = {
      expr = lib.homelab.nameToIp6."c1-1";
      expected = "2001:55d:b00b:1:224:bff:fe16:102";
    };
    test_d1_ipv6 = {
      expr = lib.homelab.nameToIp6.d1;
      expected = "2001:55d:b00b:1:224:bff:fe16:104";
    };
    test_router_ipv6 = {
      expr = lib.homelab.nameToIp6.router;
      expected = "2001:55d:b00b:1:224:bff:fe16:1";
    };
    test_ipv6_alias_dns = {
      expr = lib.homelab.nameToIp6.dns;
      expected = lib.homelab.nameToIp6.pihole-1;
    };
    test_ipv6_alias_pihole = {
      expr = lib.homelab.nameToIp6.pihole;
      expected = lib.homelab.nameToIp6.pihole-1;
    };
    test_ipv6_alias_ha = {
      expr = lib.homelab.nameToIp6.ha;
      expected = lib.homelab.nameToIp6."home-assistant";
    };
    test_plex_ipv6 = {
      expr = lib.homelab.nameToIp6.plex;
      expected = "2001:55d:b00b:1:224:bff:fe16:33c";
    };

    # === nameToMac Tests ===
    test_router_mac = {
      expr = lib.homelab.nameToMac.router;
      expected = "d2:21:f9:d9:78:8c";
    };
    test_b1_mac = {
      expr = lib.homelab.nameToMac.b1;
      expected = "00:24:0b:16:01:01";
    };
    test_c1_1_mac = {
      expr = lib.homelab.nameToMac."c1-1";
      expected = "00:24:0b:16:01:02";
    };
    test_c1_2_mac = {
      expr = lib.homelab.nameToMac."c1-2";
      expected = "00:24:0b:16:01:03";
    };
    test_d1_mac = {
      expr = lib.homelab.nameToMac.d1;
      expected = "00:24:0b:16:01:04";
    };
    test_pihole_1_mac = {
      expr = lib.homelab.nameToMac.pihole-1;
      expected = "00:24:0b:16:03:01";
    };
    test_mac_alias_dns = {
      expr = lib.homelab.nameToMac.dns;
      expected = lib.homelab.nameToMac.pihole-1;
    };
    test_mac_alias_dhcp = {
      expr = lib.homelab.nameToMac.dhcp;
      expected = lib.homelab.nameToMac.pihole-1;
    };
    test_mac_alias_mqtt = {
      expr = lib.homelab.nameToMac.mqtt;
      expected = lib.homelab.nameToMac.mosquitto;
    };

    # === nameToHost Tests ===
    test_pihole_host = {
      expr = lib.homelab.nameToHost.pihole-1;
      expected = "b1";
    };
    test_plex_host = {
      expr = lib.homelab.nameToHost.plex;
      expected = "d1";
    };
    test_samba_host = {
      expr = lib.homelab.nameToHost.samba;
      expected = "c1-1";
    };

    # === nameToIdMajor Tests ===
    test_b1_id_major = {
      expr = lib.homelab.nameToIdMajor.b1;
      expected = 1;
    };
    test_router_id_major = {
      expr = lib.homelab.nameToIdMajor.router;
      expected = 0;
    };

    # === nameToIdMinor Tests ===
    test_b1_id_minor = {
      expr = lib.homelab.nameToIdMinor.b1;
      expected = 1;
    };
    test_c1_1_id_minor = {
      expr = lib.homelab.nameToIdMinor."c1-1";
      expected = 2;
    };
    test_c1_2_id_minor = {
      expr = lib.homelab.nameToIdMinor."c1-2";
      expected = 3;
    };
    test_d1_id_minor = {
      expr = lib.homelab.nameToIdMinor.d1;
      expected = 4;
    };
    test_pihole_1_id_minor = {
      expr = lib.homelab.nameToIdMinor.pihole-1;
      expected = 1;
    };
    test_router_id_minor = {
      expr = lib.homelab.nameToIdMinor.router;
      expected = 1;
    };

    # === serverNames Tests ===
    test_b1_is_server = {
      expr = elem "b1" lib.homelab.serverNames;
      expected = true;
    };
    test_c1_1_is_server = {
      expr = elem "c1-1" lib.homelab.serverNames;
      expected = true;
    };
    test_pihole_is_not_server = {
      expr = elem "pihole-1" lib.homelab.serverNames;
      expected = false;
    };
    test_server_names_count = {
      expr = length lib.homelab.serverNames;
      expected = 5;
    };

    # === dhcpReservations Tests ===
    hasReservationWithName = name: any (r: r.name == name) lib.homelab.dhcpReservations;
    hasReservationWithMac = mac: any (r: r.mac == mac) lib.homelab.dhcpReservations;
    hasReservationWithIp = ip: any (r: r.ip == ip) lib.homelab.dhcpReservations;
    test_dhcp_reservations_non_empty = {
      expr = length lib.homelab.dhcpReservations > 0;
      expected = true;
    };
    ...
    hasContainerOption = service: opt: elem opt (lib.homelab.containerOptions service);
    test_pihole_container_options_length = {
      expr = length (lib.homelab.containerOptions "pihole-1");
      expected = 12;
    };
    ...
    test_container_options_ip6 = {
      expr = any (opt: lib.strings.hasPrefix "--ip6" opt) (lib.homelab.containerOptions "pihole-1");
      expected = true;
    };
    ...
    test_plex_container_options = {
      expr = length (lib.homelab.containerOptions "plex");
      expected = 12;
    };

    # === containerAddAllHosts Tests ===
    test_container_add_all_hosts_non_empty = {
      expr = length lib.homelab.containerAddAllHosts > 0;
      expected = true;
    };
    test_container_add_all_hosts_has_router = {
      expr = any (host: lib.strings.hasPrefix "--add-host=router:" host) lib.homelab.containerAddAllHosts;
      expected = true;
    };

    # === hosts Tests ===
    hasHostEntry = ip: name: elem name (lib.homelab.hosts.${ip} or [ ]);
    test_hosts_has_router = {
      expr = hasAttr "172.22.0.1" lib.homelab.hosts;
      expected = true;
    };
    ...
    test_hosts_iot_device = {
      expr = hasAttr "172.21.1.20" lib.homelab.hosts;
      expected = true;
    };
    ...
    test_toDebugStr_string = {
      expr = lib.homelab.toDebugStr "hello";
      expected = "hello";
    };
    test_toDebugInt = {
      expr = lib.homelab.toDebugStr 42;
      expected = "42";
    };
    test_toDebugStr_list = {
      expr = lib.homelab.toDebugStr [ "a" "b" "c" ];
      expected = ''["a","b","c"]'';
    };
    test_toDebugStr_attrs = {
      expr = lib.homelab.toDebugStr { foo = "bar"; };
      expected = ''{"foo":"bar"}'';
    };
    test_toDebugStr_boolean_true = {
      expr = lib.homelab.toDebugStr true;
      expected = "1";
    };
    test_toDebugStr_boolean_false = {
      expr = lib.homelab.toDebugStr false;
      expected = "";
    };
    test_toDebugStr_null = {
      expr = lib.homelab.toDebugStr null;
      expected = "";
    };
    test_toDebugStr_empty_list = {
      expr = lib.homelab.toDebugStr [ ];
      expected = ''[]'';
    };
    ...
    test_toDebugStr_nested_attrs = {
      expr = lib.homelab.toDebugStr { outer = { inner = "value"; }; };
      expected = ''{"outer":{"inner":"value"}}'';
    };
    test_toDebugStr_nested_lists = {
      expr = lib.homelab.toDebugStr [ [ "a" "b" ] [ "c" "d" ] ];
      expected = ''[["a","b"],["c","d"]]'';
    };
    test_toDebugStr_mixed_nested = {
      expr = lib.homelab.toDebugStr { list = [ 1 2 ]; nested = { a = { b = "c"; }; }; };
      expected = ''{"list":[1,2],"nested":{"a":{"b":"c"}}}'';
    };

    # === pretty* Tests ===
    test_prettyJson_simple = {
      expr = fromJSON (readFile (lib.homelab.prettyJson { foo = "bar"; }));
      expected = { foo = "bar"; };
    };
    test_prettyJson_nested = {
      expr = fromJSON (readFile (lib.homelab.prettyJson { items = [ 1 2 3 ]; nested = { a = "b"; }; }));
      expected = { items = [ 1 2 3 ]; nested = { a = "b"; }; };
    };
    test_prettyJson_numbers = {
      expr = fromJSON (readFile (lib.homelab.prettyJson { count = 42; pi = 3.14; }));
      expected = { count = 42; pi = 3.14; };
    };
    test_prettyToml_simple = {
      expr = fromTOML (readFile (lib.homelab.prettyToml { foo = "bar"; }));
      expected = { foo = "bar"; };
    };
    test_prettyToml_nested = {
      expr = fromTOML (readFile (lib.homelab.prettyToml { items = [ 1 2 3 ]; nested = { a = "b"; }; }));
      expected = { items = [ 1 2 3 ]; nested = { a = "b"; }; };
    };
    test_prettyToml_numbers = {
      expr = fromTOML (readFile (lib.homelab.prettyToml { count = 42; pi = 3.14; }));
      expected = { count = 42; pi = 3.14; };
    };
    # TODO: prettyYaml
    # TODO: prettyXml
    ...
    b1MacvlanSetup = (lib.homelab.mkMacvlanSetup {
      hostName = "b1";
    ...
    c1_1MacvlanSetup = (lib.homelab.mkMacvlanSetup {
      hostName = "c1-1";
      interfaceName = "mv-test";
      netdevPriority = 10;
      networkPriority = 20;
